...
- (void)setNavgationImage:(UIImage *)navgationBackImage{
    objc_setAssociatedObject(self, @selector(navgationImage), navgationBackImage, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    UIColor *color = [UIColor colorWithPatternImage:navgationBackImage];
