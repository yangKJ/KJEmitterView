...
@interface KJToastVC ()<UITableViewDelegate,UITableViewDataSource>
...
- (void)viewDidLoad {
    ...
    [tableView registerClass:[UITableViewCell class] forCellReuseIdentifier:ZOToastDemoCellId];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        ...
        UIImageView *toastView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"wode_nor"]];
